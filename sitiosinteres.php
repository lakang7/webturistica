		...
		<div class="span3">
            <div class="well">
				<ul class="nav nav-list" style="font-family: 'PT Sans Narrow', sans-serif;	" >
				  <li class="nav-header">Hospedaje</li>
				  <li><a href="#">Hoteles</a></li>
				  <li class="active"><a href="#">Posadas</a></li>	
                  <li class="divider"></li>
				  <li class="nav-header">Gastronomia</li>
				  <li><a href="#">Restaurantes</a></li>
				  <li><a href="#">Panaderias</a></li>   
                  <li class="divider"></li>
				  <li class="nav-header">Para Visitar</li>
				  <li><a href="#">Plazas</a></li>
				  <li><a href="#">Parques</a></li>  
                  <li><a href="#">Sitios Nocturnos</a></li> 
				  <li><a href="#">Iglesias</a></li>
				  <li><a href="#">Capillas</a></li>  
                  <li><a href="#">Santuarios</a></li> 
				  <li><a href="#">Monasterio</a></li>
				  <li><a href="#">Museos</a></li>  
                  <li><a href="#">Paseos Artesanales</a></li>    
				  <li><a href="#">Liceos</a></li>  
                  <li><a href="#">Universidades</a></li>                                                      
                  <li class="divider"></li>
				  <li class="nav-header">Salud</li>
				  <li><a href="#">Hospitales</a></li>
				  <li><a href="#">Clinicas</a></li>  
                  <li><a href="#">Centros Asistenciales</a></li>  
                  <li class="divider"></li>
				  <li class="nav-header">Dinero</li>
				  <li><a href="#">Bancos</a></li>
				  <li><a href="#">Cajeros Automaticos</a></li>
                  <li class="divider"></li>
				  <li class="nav-header">Estaciones de Servicio</li>
